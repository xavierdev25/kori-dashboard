...
export function DeleteProductDialog({
  ...
  return (
    <ConfirmDialog
      description={
        product?.isActive
          ? "Esta publicado: desaparece de la tienda en cuanto lo borres. Se van con el sus variantes, sus imagenes y el archivo que se vende. No se puede deshacer."
          : "Se borran el producto, sus variantes, sus imagenes y el archivo que se vende. No se puede deshacer."
      }
